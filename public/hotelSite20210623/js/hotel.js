...
function valueChange(){
    // イベントが発生した時の処理
    let roomCount = roomCountId.value;
}

let roomCountId = document.getElementById('roomCount');
roomCountId.addEventListener('change', valueChange);
...
// roomCount.addEventListener('change', valueChange);
